                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      if (selectedStateName == 'not set') { 
                         Util.tostMassage("Select state");
                        return;
                      }
                      if (selectedStateID == 'not set') { 
                           Util.tostMassage("Something went wrong!");
                        return;
                      }
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      if (selectedDistrictName == 'not set') {
                         Util.tostMassage("Select district");
                  ...
                  Align(
                    ...
                    child: InkWell(
                          ...
                          onTap: () {
                          if (selectedStateName == 'not set') { 
                             Util.tostMassage("Please select state");
                            return;
                          }
                  
                          if (selectedDistrictName == 'not set') {
                             Util.tostMassage("Please select district");
                            return;
                          }
                          if (selectedTalukaName == 'not set') { 
                             Util.tostMassage("Please select Taluka");
                            return;
                          }
                  
                          if (villageNameController.text.toString().trim().isEmpty) {
                             Util.tostMassage("Please enter village name");
                            return;
                          }
                  
                          if (villageNameController.text.toString().trim().length < 3) {
                            Util.tostMassage("Please enter more than 3 characters in village name");
                          ...
                          //showProgressIndicator();
                              ...
                              authViewMode.userUpdateAddress(
                               context,selectedTalukaID,
                               selectedTalukaName,
                               selectedDistrictID,
                        ...
                        child:authViewMode.addressLOading? Row(
                          children: [ 
                            SizedBox( 
                              height: 40,
                              width: 40,
                      ...
                      child: Container(
                        ...
                        child: Text('Submit',style: TextStyle(color: kWhite, fontSize: 15, fontWeight: FontWeight.bold),),
