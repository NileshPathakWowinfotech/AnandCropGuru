                                            ...
                                            InkWell(
                                              onTap: (){
                                                setState(() {
                                                  likebtn = !likebtn;
                                                  postApi();
                                                  PostLikeApi.postlikeapi(listresponse![index]["USER_ID"].toString(),listresponse![index]["POST_ID"].toString());

                                                });
                                              },
                                              child:listresponse![index]["MY_LIKE_COUNT"].toString() == "0"? Image.asset("assets/images/like.png",
                                                  height: 25, color: kgreen): Image.asset("assets/images/like2.png", height: 25, color: kgreen),
                                          ...
                                          children: [
                                            GestureDetector(
                                              ...
                                              child: Icon(Icons.share, size: 25,
                                                color: kgreen,),
                                              onTap: (){
                                                Share.share("${listresponse![index]["POST_PHOTO"]}  ");
                                              },
                                            ),
                                            SizedBox(width: 8,),
