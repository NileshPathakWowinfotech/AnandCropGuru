...
String SelectOption = ' ';
  ...
  Future unitapi() async {
    ...
    response = await http.post(
        Uri.parse(
            'http://mycropguruapiwow.cropguru.in/api/ n'),
  ...
  Widget catName() {
    ...
    return DropdownButtonHideUnderline(
      ...
      child: ChangeNotifierProvider<ExpansesViewModel>(
          ...
          child: Consumer<ExpansesViewModel>(builder: (context, value, _) {
            switch (value.categoryNameList.status!) {
              case Status.LOADING:
                return SizedBox();
              case Status.ERROR:
                return Center(child: Text(value.categoryNameList.message.toString()));
        ...
        child: Padding(
          ...
          child: Container(
            ...
            child: DropdownButtonFormField(
              ...
              items: value.categoryNameList.data!.data.map((product) {
                ...
                setState(() {
                  ...
                  Timer(Duration(seconds: 1), () {
                    ...
                    print("Yeah, this line is printed immediately${cropId= product.catId.toString()}");
                    cropNameGlobal= product.catName;
                    cropId= product.catId.toString() ?? '';
                  });
                });
              ...
              await  expansesViewModel.productListDropDownList(widget.userID,cropId);
               print('hello');
    ...
    return  ChangeNotifierProvider<ExpansesViewModel>(
          ...
          child: Consumer<ExpansesViewModel>(builder: (context, value, _) {
            switch (value.productNameList.status!) {
              case Status.LOADING:
                return SizedBox();
              case Status.ERROR:
                return Center(child: Text(value.productNameList.message.toString()));
              case Status.COMPLETED:
                return     SingleChildScrollView(
        child: Padding(
      ...
      child: ButtonTheme(
          ...
          child: DropdownButtonFormField(
            ...
            isExpanded: true,
            items:value.productNameList.data!.data.map((product) {
              return DropdownMenuItem(
                onTap: (){
