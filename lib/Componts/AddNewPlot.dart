                        ...
                        child: Column(
                          ...
                          children: [
                            Container( 
                              ...
                              color: lgreen,
                              child: Center(
                                child: Text('Crop variety :', style: TextStyle(
                          ...
                          Padding(
                            ...
                            child: Text('Other',style: TextStyle(color: kblack, fontSize: 17, fontWeight: FontWeight.bold),),
                          ),
                            SizedBox(height: 10,),
                            Divider(height: 1,color: kblack,)
                          ],
                        )),
