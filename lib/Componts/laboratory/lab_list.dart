      ...
      child: Consumer<HomeViewViewModel>(builder: (context, value, _) {
        switch (value.lablist.status!) {
          ...
          case Status.COMPLETED:
            return value.lablist.data!.data.isEmpty
                ? Center(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Admin Remark :  ${value.lablist.data!.data[index].adminRemark.toString() == 'null' ? "" : value.lablist.data!.data[index].adminRemark.toString()}',
                                    style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        color: kblack),
                                  ),
