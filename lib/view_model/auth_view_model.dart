...
class AuthViewModel with ChangeNotifier {
  ...
  // User Update Address
  Future<void> userUpdateAddress( BuildContext context, talukaId,
    talukaName, districtID, distrctName , stateId, stateName, villageName) async { 
